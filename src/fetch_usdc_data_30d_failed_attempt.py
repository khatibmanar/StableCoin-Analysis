...
# """
# Naive attempt to fetch 30 days of USDC transfers via the Etherscan ERC-20 API.

# This approach fails due to the 10,000 transaction per-query cap on high-activity days.
# It is retained for documentation purposes and to motivate the block-by-day strategy
# implemented in fetch_usdc_data_30d.py and Phase 1.5 of the analysis.

# Not used in final data pipeline.
# """
